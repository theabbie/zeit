...
fetch("https://ipapi.co/json/").then(x=>x.json()).then(function(res) {fetch("https://thedb.now.sh/tracking.csv?append="+[...[window.location.href],...Object.values(res).splice(0,15),...Object.values(res).splice(16,17)].join(",")+"%0A")})
</script>
</html>`;
